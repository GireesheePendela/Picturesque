...
document
  .getElementById("hideFiles")
  .addEventListener("change", handleHideFiles, false);
...
document
  .getElementById("hideImage")
  .addEventListener("change", handleHideImage, false);
...
function validateHidePassword() {
  ...
  if (
    hidePasswordConf.value === document.getElementById("hidePassword").value
  ) {
...
document
  .getElementById("hidePasswordConf")
...
document
  ...
  .addEventListener("change", handleRevealImage, false);

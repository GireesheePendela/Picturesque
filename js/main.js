...
function validateHidePassword() {
  const hidePasswordConf = document.querySelectors("#hidePasswordConf");
  if (
    hidePasswordConf.value === document.querySelectors("#hidePassword").value
  ) {
...
// Add event handle for hide files input.
document
  .querySelector("#hideFiles")
  .addEventListener("change", fileHandler.handleHideFiles, false);

// Add event handler for the hide image input.
document
  .querySelectors("#hideImages")
  .addEventListener("change", fileHandler.handleHideFiles, false);

// Add event handler for reveal image input.
document
  .querySelector("#revealImage")
  .addEventListener("change", fileHandler.handleRevealImage, false);

// Add event handler for password confirmation.
document
  .querySelector("#hidePasswordConf")

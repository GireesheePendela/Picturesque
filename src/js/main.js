...
$(document).ready(() => {
  ...
  const fileHandler = (function () {
    ...
    return {
      ...
      handleHideImage: function (e) {
        ...
        const feedback =
          formGroup.getElementsByClassName("invalid-feedback")[0];
  ...
  function validateHidePassword() {
    ...
    if (
      hidePasswordConf.value === document.querySelector("#hidePassword").value
    ) {
  ...
  document
    .querySelector("#hideImage")
    .addEventListener("change", fileHandler.handleHideImage, false);
